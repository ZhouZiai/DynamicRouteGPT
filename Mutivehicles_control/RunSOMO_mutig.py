...
def run():
    ...
    for i in range(car_num):
        ...
        # 创建车辆并分配路线
        traci.vehicle.add(vehicle_id, route_id,depart=1214,departPos=0,departSpeed=10)
        # 收集车辆ID
...
if __name__ == '__main__':
    ...
    netData = sumolib.net.readNet(net_file)
    print(netData)
    car_num  = 1  #'top0A3','A0left0','D0right0','bottom2C0','right3D3','A1left1','bottom0A0','C3top2,'top3D3','top1B3','left3A3','D3right3'
    start_edges = ['left2A2']
    end_edges = ['A2A1']
    # 加载网络
    # Grah = save_network()
