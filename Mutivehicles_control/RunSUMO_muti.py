...
#     # 开始运行仿真
#     run()
####################################### 每个路口DJ   ||| 每个路口决策一次me |||每个红绿灯决策一次 ||  调整之后
###########58043  在道路不太拥堵时，用时差不多 1  443
###########Scale Traffic =2时   454|||||750  ||| 642  ||| 445
###########Scale Traffic =3时  454    |||||750   ||| 642 |||629
###########Scale Traffic =5时  525    |||||724   ||| 616  ||| 615
###############Scale Traffic =10 时   1200   |||||||||718 |||628 |||613