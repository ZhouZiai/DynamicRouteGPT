...
graph_path = r'D:\intereting\DynamicNavigation\findPath\findPath\hangzhou_route.pkl'
def load_network():
    # 从文件加载图
...
def run():
    ...
    for i in range(car_num):
        ...
        # 添加路线到路网中
        traci.route.add(route_id, shortest_edge_list,departSpeed=10)       
        # 创建车辆并分配路线
    ...
    while traci.simulation.getMinExpectedNumber() > 0:
        ...
        for vechicle_id in vehicle_ids:
            ...
            if vechicle_id in traci.vehicle.getIDList():
                ...
                # 假设traci.vehicle.getLaneID(vechicle_id)返回的是"road_4_1_0_0"
                ...
                if len(parts) > 1:  # 确保有下划线可以分割
                    ...
                    result = lane_id  # 如果没有下划线，直接使用原字符串
                edge_list[i] = result
                # edge_list[i]=traci.vehicle.getLaneID(vechicle_id)
